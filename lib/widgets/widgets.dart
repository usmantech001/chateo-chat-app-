...
Widget inputContainer({
  ...
  return  Container(
              ...
              child: Row(
                children: [
                  Icon(icon, size: 22.sp,color: Colors.black.withOpacity(0.3),),
                  Expanded(
                    child: TextFormField(
                 ...
                 isPassword==true? GestureDetector(
                  onTap: onTap,
                  child: Icon(Icons.remove_red_eye_sharp, size: 22.sp,color: Colors.black.withOpacity(0.3),)):Container()
                ],
              ),
            );
}
