        ...
        ConstrainedBox(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                borderRadius: msgContent.type == 'text'
                    ? BorderRadius.only(
                          ...
                          Align(
                              ...
                              child: reusableText(
                                  text: DateFormat().add_jm().format(
                                      (msgContent.addtime! as Timestamp)
                                          .toDate()),
                ...
                : Column(
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: reusableText(
                              text: DateFormat().add_jm().format(
                                  (msgContent.addtime! as Timestamp).toDate()),
                              color: const Color(0xFFFFFFFF),
                              fontSize: 12))
                    ],
                  ),
...
// ignore: non_constant_identifier_names
Widget ChatRight1(MsgContent msgContent, DateTime time) {
  return Column(
    children: [
      Container(
